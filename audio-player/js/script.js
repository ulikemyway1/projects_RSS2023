document.addEventListener('DOMContentLoaded', ()=>{
    ...
    {'src': 'audio/oxy.mp3',
        ...
        'img': 'img/oxy.jpg',
    'lyricks': `[Интро]<br>
    Были и нет, пузырики вверх<br>
    Длинный след, счастливый билет, всё ниже, смелей<br>
    Постепенно<br>
    В культурный слой через перегной<br>
    Чернозём, мел и мезозой, сверху до низов<br>
    Погружение<br>
    Были и нет, пузырики вверх<br>
    Длинный след, счастливый билет, всё ниже, смелей<br>
    Постепенно<br>
    ...
    Чернозём, мел и мезозой, сверху до низов<br>
    С ускорением<br>
    Вон из окна в колодец двора<br>
    Глубока кроличья нора, доводит до дна<br>
    Затемнение <br>
    Вниз головой, все риски долой<br>
    Бесконтрольно прыгай за мной, нырни с головой<br>
    Погружение<br>
    <br><br>
    [Куплет]<br>
    Как в студень, желеобразный как пудинг<br>
    Двести метров дальше — подспуден, страх, но лезем дальше в санузел<br>
    Пятна света нас не разбудят, лиц нету, шаг труден<br>
    Эка незадача по сути, вдалеке маячит распутье<br>
    Далеко внизу — там огни, на дно несут, как магнит<br>
    Так проходят в сумраке дни, мы скоро трое суток одни<br>
    Завяжи с попытками ждать, затяни погромче мотив<br>
    Завяжи покрепче глаза и затяни потуже ремни<br>
    Лучше не волю собери в кулак, а горе собери в кулёк<br>
    Крутись, лебёдка, в бездну прёт фуникулёр<br>
    Ты не каникуляр тут, глянь, как дно горит углём<br>
    С этих полётов дух захватит в лёгких, как туберкулёз<br>
    Падаем, не то парим, не то плаваем<br>
    Погребены под завалами, глубина воды, будто занавес<br>
    И наверх всплыть надо бы, но далёкое дно по душе мне<br>
    И я забыл своё имя и прошлое, всё, что отныне дано мне — одно<br>
    <br><br>
    [Припев]<br>
    Погружение<br>
    Были и нет, пузырики вверх<br>
